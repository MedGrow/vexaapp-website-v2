...
Application refers to VexaApp, the software program provided by the Company.

Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to VexaApp.

Cookies are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.Country refers to: Delaware, United States.
...
Website refers to VexaApp, accessible from https://vexaapp.net and https://my.vexaapp.net.
...
If you have any questions about this Privacy Policy, You can contact us by email: support@vexaapp.net
